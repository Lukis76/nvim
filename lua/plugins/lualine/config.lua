...
local function ins_left_a(component)
    table.insert(opts.sections.lualine_a, component)
end

-- Inserts a component in lualine_b at left section
local function ins_left_b(component)
    table.insert(opts.sections.lualine_b, component)
end
...
ins_left_c({
    ...
    symbols = {
        added = Default.icons.git.Added,
        modified = Default.icons.git.Modified,
        removed = Default.icons.git.Removed
    },                                         -- 柳
    diff_color = {
...
ins_right_x({
    ...
    symbols = {
        ...
        warn = Default.icons.diagnostics.BoldWarning,
